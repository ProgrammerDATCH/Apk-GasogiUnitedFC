    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkRun = new Runnable() {
            ...
            public void run() {
                ...
                {
                    Toast.makeText(MainActivity.this, "No internet Connection to load GASOGI United FC Server!", Toast.LENGTH_LONG).show();
                    checkConn.postDelayed(checkRun, 10000);
                }
                else
                {
                    Toast.makeText(MainActivity.this, "Connected to GASOGI United FC Server", Toast.LENGTH_SHORT).show();
                    //good
